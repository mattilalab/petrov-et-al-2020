...
SEQOPT=( "Pair UniProt <-> OrthoDB <-> OGuniqueID"
         ...
         "Prepare BLAST database from UniProt sequences"
         ...
         "[RUN] Create all unique pairs (increment by $INCR)"
...
for folder in * ; do
  ...
  #echo -e "\nColumns for which co-evolution was found are placed in:\n\e[96m$TMP/$RESULTS/columnStats\e[39m\n"
  cd ..
done
